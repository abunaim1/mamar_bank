...
from .models import Transaction, BankCrupt
...
class TransactionModel(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        if obj.loan_approve:
            ...
            obj.account.save()
            send_transaction_email(obj.account.user, obj.amount, 'Loan Approaval', 'admin_email.html')
        super().save_model(request, obj, form, change)
admin.site.register(BankCrupt)